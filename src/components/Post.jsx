      ...
      <main className="max-w-2xl mx-auto p-4">
        ...
        >
          ...
          <div className="flex items-center gap-3 p-4 border-b border-border/50">
            <img 
              src={profile?.photoURL || user?.photoURL || `https://api.dicebear.com/7.x/avataaars/svg?seed=${profile?.username}`}
              alt="Profile"
          ...
          <form onSubmit={handlePost} className="p-4 space-y-4">
            ...
            <div className="flex items-center justify-between p-3 bg-muted/30 rounded-xl">
              ...
              <div className="flex items-center gap-1">
                <button type="button" className="p-2 hover:bg-muted rounded-full transition-colors text-yellow-500">
                  <Smile size={20} />
                </button>
                <button type="button" className="p-2 hover:bg-muted rounded-full transition-colors text-blue-500">
                  <MapPin size={20} />
                </button>
                <button type="button" className="p-2 hover:bg-muted rounded-full transition-colors text-green-500">
                  <Hash size={20} />
                </button>
              </div>
            </div>
            ...
            <motion.button 
              ...
              className="w-full h-14 bg-primary text-primary-foreground rounded-xl font-bold shadow-lg shadow-primary/25 hover:shadow-primary/40 disabled:opacity-50 disabled:shadow-none transition-all flex items-center justify-center gap-2"
            >
              {loading ? (
